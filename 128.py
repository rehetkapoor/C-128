...
browser=webdriver.Chrome("C:/Users/rehet/OneDrive/Rehet Documents/Desktop/C-127/chromedriver")
...
for index, data in enumerate(planet_data):
    ...
    print(f"Scraping in hyperlink {index+1} is completed")
